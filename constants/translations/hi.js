...
export const hi = {
  ...
  subscribe: "सदस्यता लें — $9.99/माह",
  ...
  planTrialActive: (days) => `मुफ़्त ट्रायल (${days} दिन बाकी)`,
  planTrialExpired: "ट्रायल समाप्त",
  upgradeToPremium: "प्रीमियम में अपग्रेड करें",
  viewPlans: "योजनाएं देखें",
  manageSubscription: "सदस्यता प्रबंधित करें",
  restorePurchases: "पुरानी खरीद वापस पाएं",
  restoreSuccessTitle: "खरीद वापस मिली",
  restoreSuccessMessage: "आपकी प्रीमियम सदस्यता सफलतापूर्वक बहाल कर दी गई है!",
  restoreNoneTitle: "कोई सदस्यता नहीं मिली",
  restoreNoneMessage: "आपके खाते से जुड़ी कोई सक्रिय सदस्यता नहीं मिली।",
  restoreErrorTitle: "बहाली असफल",
